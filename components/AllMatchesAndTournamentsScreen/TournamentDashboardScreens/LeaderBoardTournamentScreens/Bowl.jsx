...
export default function Bowl() {
  ...
  const [playerData, setPlayerData] = useState([
    {
      ...
      gameDetail: 'inn:2 | w:5 | eco:7.24 | avg:8.2',
      progressCount : 0.8
    },
    {
      id: 2,
      ...
      name: 'alpesh b',
      gameDetail: 'inn:2 | w:3 | eco:6.75 | avg:9',
      progressCount : 0.7
  ...
  return (
    ...
    {/* <Text style={styles.inputlebl}>most wickets</Text> */}
          ...
          <>
            <View
              ...
              <View style={styles.playerInfoSection}>
                ...
                {item.gameDetail.split('|')[2]} | {item.gameDetail.split('|')[3]}
                </Text>
              </View>
